...
saData = data[data['Country/Region']=="Algeria"][['Confirmed','Deaths','Recovered']]
...
xtrain = cnsa.iloc[:106,:-2]
xtest = cnsa.iloc[106:,:-2]
ytrain = cnsa['CP'].iloc[:106]
ytest = cnsa['CP'].iloc[106:]

ytrainDP = cnsa['DP'].iloc[:106]
ytestDP = cnsa['DP'].iloc[106:]
...
DataTOPlotConf = data[data['Country/Region']=="Algeria"][['ObservationDate','Confirmed','Deaths']]
...
#DataTOPlotConf.to_csv("AlgeriaDataVizData.csv")
